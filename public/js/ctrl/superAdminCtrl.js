app
.controller('SuperAdmin_WarungCtrl', ['$scope', 'WarungService', '$mdDialog', '$mdToast', function ($scope, WarungService, $mdDialog, $mdToast) {
  $scope.state = {
    title: 'Data Warung',
...
.controller('SuperAdmin_MakananCtrl', ['$scope', 'MakananService', '$mdDialog', '$mdToast', function ($scope, MakananService, $mdDialog, $mdToast) {
  $scope.state = {
    title: 'Data Makanan',
  ...
  MakananService.getMakananAll()
    ...
    .then(data => {
      $scope.state.kategori = data;
      return MakananService.getWarungAll();
    })
    .then(data => {
...
.controller('SuperAdmin_ProfileCtrl', ['$scope', 'AuthService', '$mdDialog', '$mdToast', function ($scope, AuthService, $mdDialog, $mdToast) {
  $scope.state = {
